...
const folders = [
  'public/icons/stratagems',
  'public/icons/weapons',
  'public/icons/armor',
  'public/icons/grenades',
  'public/icons/warbonds'
];

console.log('🔧 Creando estructura de carpetas para iconos...\n');
...
const readmeContent = `# 🎮 Iconos para Helldivers Build Generator
...
console.log('📂 Las carpetas están en: public/icons/');
console.log('\n👉 Próximos pasos:');
console.log('1. Descarga los iconos desde la Helldivers Wiki');
console.log('2. Colócalos en las carpetas correspondientes');
console.log('3. Ejecuta "npm run dev" para ver los iconos en la aplicación');